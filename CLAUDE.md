...
See [docs/PHASE1-SPECIFICATION.md](docs/PHASE1-SPECIFICATION.md) for the functional specification, architecture, folder structure, navigation, and agent lifecycle. See [docs/DATABASE-SCHEMA.md](docs/DATABASE-SCHEMA.md), [docs/AGENTS.md](docs/AGENTS.md), [docs/MCP-TOOLS.md](docs/MCP-TOOLS.md), [docs/UI-WIREFRAMES.md](docs/UI-WIREFRAMES.md), [docs/USER-ROLES-AND-STORIES.md](docs/USER-ROLES-AND-STORIES.md), and [docs/SECURITY-COMPLIANCE-OVERVIEW.md](docs/SECURITY-COMPLIANCE-OVERVIEW.md) for the supporting detail documents. See [ROADMAP.md](ROADMAP.md) for the full 16-phase internal build-process roadmap, [docs/PRODUCT-ROADMAP.md](docs/PRODUCT-ROADMAP.md) for the v1 → v2 → v3 product capability roadmap (a different document — do not confuse the two), and [WORKFLOW.md](WORKFLOW.md) for the end-to-end workflow specification (how the system operates, agent-to-agent handoffs, MCP lifecycle, approval gates). See [docs/PHASE2-CORE-TECHNICAL-ARCHITECTURE.md](docs/PHASE2-CORE-TECHNICAL-ARCHITECTURE.md) for the deepened internal architecture, [docs/PHASE3-MOCK-AI-PROVIDER-FOUNDATION.md](docs/PHASE3-MOCK-AI-PROVIDER-FOUNDATION.md) for the Provider Interface, [docs/PHASE4-DATABASE-DESIGN.md](docs/PHASE4-DATABASE-DESIGN.md) for the ERD/indexing/constraints, [docs/PHASE5-FOLDER-STRUCTURE.md](docs/PHASE5-FOLDER-STRUCTURE.md) for where every class lives on disk, [docs/PHASE6-AGENT-ARCHITECTURE.md](docs/PHASE6-AGENT-ARCHITECTURE.md) for full per-agent Context/Prompt/Events/Escalation detail, [docs/PHASE7-MCP-ARCHITECTURE.md](docs/PHASE7-MCP-ARCHITECTURE.md) for the Tool Registry/Permission Model/Contracts, [docs/PHASE8-WORKFLOW-ENGINE-ORCHESTRATION.md](docs/PHASE8-WORKFLOW-ENGINE-ORCHESTRATION.md) for Parallel/Sequential Execution and Pause/Resume Logic, and [docs/PHASE9-UI-UX-SPECIFICATION.md](docs/PHASE9-UI-UX-SPECIFICATION.md) for Information Architecture and every page's specification. **All 16 ROADMAP.md phases now have a specification** — Phases 1-9 (docs) are complete and closed; Phases 10-16 (code: Plugin Skeleton, Migrations, Provider/MCP/Orchestration/UI implementation, Enterprise Readiness) are fully spec'd as gate-approved tickets in `backlog/specification/` but **not implemented** — no code exists yet, per the Golden Rule.
